const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/LoginPage-BC62Eq19.js","assets/label-GCOsfg4S.js","assets/proxy-Dmz4vUEZ.js","assets/DashboardPage-DvpQambj.js","assets/ConnectionsPage-ghP3_bY3.js","assets/MathPage-CZktc8LS.js"])))=>i.map(i=>d[i]);
...
const useMotorStore = create((set) => ({
  ...
  isSwitching: false,
  activeMotorId: 1,
  setMotor1: (update) => set((state) => ({ motor1: { ...state.motor1, ...update } })),
  setMotor2: (update) => set((state) => ({ motor2: { ...state.motor2, ...update } })),
...
function nextTemp(current, isOn) {
...
function useMotorSimulation() {
  const store = useMotorStore();
  const storeRef = reactExports.useRef(store);
  storeRef.current = store;
  const alertCooldown = reactExports.useRef(/* @__PURE__ */ new Set());
  reactExports.useEffect(() => {
    const interval = setInterval(() => {
      const { motor1, motor2, setMotor1, setMotor2, addAlert } = storeRef.current;
      ...
      setMotor1({
        ...
        runtimeHours: motor1.isOn ? Math.round((motor1.runtimeHours ?? 0) * 10 + 1 / 360) / 10 : motor1.runtimeHours
      });
      setMotor2({
        temperature: newTemp2,
        current: motor2.isOn ? 4.8 + (Math.random() - 0.5) * 0.4 : 0,
        rpm: motor2.isOn ? 1750 + Math.floor((Math.random() - 0.5) * 50) : 0,
        runtimeHours: motor2.isOn ? Math.round((motor2.runtimeHours ?? 0) * 10 + 1 / 360) / 10 : motor2.runtimeHours
      });
      const motorChecks = [
      ...
      for (const { id, temp, isOn, name } of motorChecks) {
        if (isOn && temp > OVERHEAT_THRESHOLD && !alertCooldown.current.has(id)) {
          ...
          addAlert(alert);
          setTimeout(() => alertCooldown.current.delete(id), 15e3);
        }
      }
    }, 2e3);
...
function useMatchRoute() {
  ...
  useRouterState({
    select: (s) => {
      var _a2;
      return [s.location.href, (_a2 = s.resolvedLocation) == null ? void 0 : _a2.href, s.status];
    },
    structuralSharing: true
  });
  return reactExports.useCallback(
    (opts) => {
      ...
      return router2.matchRoute(rest, {
        pending,
        caseSensitive,
        fuzzy,
        includeSearch
    ...
    setTimeout(() => {
      set({
        ...
        devices: MOCK_DEVICES.map((d) => ({
          ...d,
          signalStrength: d.connected ? Math.min(
            100,
...
function NavBar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "header",
    {
      ...
      "data-ocid": "navbar",
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-screen-xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Link,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded-lg bg-primary flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "w-4 h-4 text-primary-foreground" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm tracking-tight", children: "AgriFlux" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex items-center gap-1", "data-ocid": "navbar.nav", children: navLinks.map(({ to, label, active }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Link,
          {
            to,
            className: cn(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 shrink-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden sm:flex items-center gap-1.5 text-xs text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Wifi, { className: "w-3.5 h-3.5 text-secondary" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              children: resolvedTheme === "dark" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Sun, { className: "h-4 w-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Moon, { className: "h-4 w-4" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
...
function AppLayout() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 w-full max-w-screen-xl mx-auto px-4 sm:px-6 py-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-muted/40 border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-screen-xl mx-auto px-4 sm:px-6 h-10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
      "© ",
...
const LoginPage = reactExports.lazy(() => __vitePreload(() => import("./LoginPage-BC62Eq19.js"), true ? __vite__mapDeps([0,1,2]) : void 0));
const DashboardPage = reactExports.lazy(() => __vitePreload(() => import("./DashboardPage-DvpQambj.js"), true ? __vite__mapDeps([3,2]) : void 0));
const ConnectionsPage = reactExports.lazy(() => __vitePreload(() => import("./ConnectionsPage-ghP3_bY3.js"), true ? __vite__mapDeps([4,2]) : void 0));
const MathPage = reactExports.lazy(() => __vitePreload(() => import("./MathPage-CZktc8LS.js"), true ? __vite__mapDeps([5,1,2]) : void 0));
...
const connectionsRoute = createRoute({
  getParentRoute: () => protectedLayout,
  path: "/connections",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(ConnectionsPage, {}) })
});
const mathRoute = createRoute({
  getParentRoute: () => protectedLayout,
  path: "/math",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(MathPage, {}) })
});
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(J, { attribute: "class", defaultTheme: "light", enableSystem: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(RouterProvider, { router }) });
}
