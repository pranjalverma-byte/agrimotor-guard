...
export class Backend implements backendInterface {
    ...
    async getDevices(): Promise<Array<DeviceInfo>> {
        if (this.processError) {
            try {
                const result = await this.actor.getDevices();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getMotors(): Promise<Array<MotorStatus>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMotors();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTempPrediction(arg0: bigint, arg1: bigint): Promise<TempPrediction> {
        if (this.processError) {
            try {
                const result = await this.actor.getTempPrediction(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTemperatureAlerts(): Promise<Array<TemperatureAlert>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTemperatureAlerts();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async refreshDevices(): Promise<Array<DeviceInfo>> {
        if (this.processError) {
            try {
                const result = await this.actor.refreshDevices();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async switchMotor(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.switchMotor();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
